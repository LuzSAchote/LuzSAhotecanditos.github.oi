<div class="row">
  <div class="clo-md-12 text-center">
      <img src="<?php echo base_url(); ?>/assets/images/nac.jpg" width="400" height="200">
   </div>
  </div>
  <b><h1 class="text-center" style="color:#C71585;"><b><i><u>MAPA DE IDEOLOGIA</u></i></b></h1></b>
      <div class="row">
        <div class="col-md-12">
      ...
      function initMap(){
        ...
        <?php if($candidato4): ?>
        <?php foreach ($candidato4 as $filaTemporal): ?>
